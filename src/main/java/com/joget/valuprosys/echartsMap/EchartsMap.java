...
public class EchartsMap extends UserviewMenu {
	...
	private static final String OPEN_URL_PARAM_OF_PARENT_MAP = "openUrlParamOfParentMap";
	private static final String OPEN_URL_PARAM_OF_SERIES = "openUrlParamOfSeries";
	...
	private static final List<String> PARAM = Arrays.asList("devMode","width", "height",BACK_GROUND_COLOR,FONT_COLOR, "mapLabel","mapSubLabel",
				...
				OPEN_URL_FLAG,OPEN_URL_PROVINCE_FLAG,OPEN_URL,OPEN_URL_TYPE,OPEN_URL_PARAM_OF_MAP,OPEN_URL_PARAM_OF_PARENT_MAP,
				OPEN_URL_PARAM_OF_SERIES,OPEN_URL_PARAM_VALUE,OPEN_URL_PARAM_VALUE,
	...
	public String getRenderPage() {
		...
		String locationParentParam = getPropertyString(OPEN_URL_PARAM_OF_PARENT_MAP); 
		String seriesParam = getPropertyString(OPEN_URL_PARAM_OF_SERIES);
		String locationValue = "@LOCATION@";
		String locationParentValue = "@PARENTLOCATION@";
		...
		String openUrl = OpenUrlUtils.getFullUrl(url, locationParam,locationParentParam,seriesParam, locationValue, locationParentValue,
				seriesValue, paramNames, paramValues);
